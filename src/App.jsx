...
const HOWTOS = [
  { id: "solver", title: "Set up & run Solver", tag: "optimization",
    ...
    steps: [
      { do: "Turn Solver on (one-time)", path: "File ▸ Options ▸ Add-ins ▸ Manage: Excel Add-ins ▸ Go… ▸ ✓ Solver Add-in ▸ OK", why: "Solver ships with Excel but is off by default. Once enabled it appears in the Data ribbon's Analyze group." },
      ...
      { do: "Pick the method and solve", path: "Select 'Simplex LP' ▸ ✓ Make Unconstrained Variables Non-Negative ▸ Solve ▸ Keep Solver Solution", why: "Simplex LP is exact for linear models and handles integers via branch-and-bound." },
    ] },
